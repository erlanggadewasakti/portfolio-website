          ...
          >
            ...
            >
              ...
              <div className="absolute z-10 top-4 right-4">
                <button
                  onClick={onClose}
                  className="p-2 transition-all duration-200 rounded-full shadow-lg bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-800 backdrop-blur-sm"
                >
              ...
              <div className="overflow-y-auto max-h-[90vh]">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="mb-8">
                    ...
                    {project.type === "AI" && (
                      <div className="p-4 border rounded-lg bg-cyan-50 dark:bg-cyan-900/20 border-cyan-200 dark:border-cyan-800">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="px-4 py-2 text-sm font-medium text-purple-700 transition-transform duration-200 border rounded-lg bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 dark:text-purple-300 border-purple-200/50 dark:border-purple-700/50 hover:scale-105"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row">
                    {project.demoUrl && (
                      <a
                        ...
                        className="flex items-center justify-center gap-3 px-6 py-3 font-medium text-white transition-all duration-300 bg-purple-600 rounded-lg shadow-lg hover:bg-purple-700 hover:shadow-xl hover:scale-105"
                      >
                    ...
                    {project.githubUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-3 px-6 py-3 font-medium text-gray-900 transition-all duration-300 bg-gray-100 rounded-lg shadow-lg hover:bg-gray-200 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 hover:shadow-xl hover:scale-105"
                      >
                    ...
                    {!project.demoUrl && !project.githubUrl && (
                      <div className="flex items-center justify-center gap-3 px-6 py-3 font-medium text-gray-500 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-400">
